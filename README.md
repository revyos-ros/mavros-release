## mavros (jazzy) - 2.10.1-1

The packages in the `mavros` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy mavros --override-release-repository-push-url git@github.com:revyos-ros/mavros-release.git` on `Mon, 23 Jun 2025 05:04:39 -0000`
...
The packages in the `mavros` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble mavros --override-release-repository-push-url git@github.com:revyos-ros/mavros-release.git` on `Tue, 17 Jun 2025 04:33:08 -0000`
...
The packages in the `mavros` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy mavros --override-release-repository-push-url git@github.com:revyos-ros/mavros-release.git` on `Sat, 12 Oct 2024 04:55:36 -0000`
...
The packages in the `mavros` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy mavros --override-release-repository-push-url git@github.com:revyos-ros/mavros-release` on `Mon, 24 Jun 2024 09:55:29 -0000`
...
## mavros (humble) - 2.7.0-2

The packages in the `mavros` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble mavros` on `Tue, 21 May 2024 06:30:29 -0000`
...
## mavros (melodic) - 0.26.3-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Tue, 21 Aug 2018 13:38:57 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.26.2-0`
- old version: `0.26.2-0`
- new version: `0.26.3-0`
...
## mavros (lunar) - 0.26.3-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Tue, 21 Aug 2018 13:31:43 -0000`
...
## mavros (kinetic) - 0.26.3-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Tue, 21 Aug 2018 13:26:07 -0000`
...
## mavros (melodic) - 0.26.2-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Wed, 08 Aug 2018 09:26:58 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.26.1-0`
- old version: `0.26.1-0`
- new version: `0.26.2-0`
...
## mavros (lunar) - 0.26.2-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Wed, 08 Aug 2018 08:40:14 -0000`
...
## mavros (kinetic) - 0.26.2-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Wed, 08 Aug 2018 08:32:23 -0000`
...
## mavros (melodic) - 0.26.1-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Thu, 19 Jul 2018 20:17:25 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.26.0-0`
- old version: `0.26.0-0`
- new version: `0.26.1-0`
...
## mavros (lunar) - 0.26.1-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Thu, 19 Jul 2018 20:04:44 -0000`
...
## mavros (kinetic) - 0.26.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Thu, 19 Jul 2018 19:53:01 -0000`
...
## mavros (melodic) - 0.26.0-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Wed, 06 Jun 2018 07:41:16 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.25.1-0`
- old version: `0.25.1-0`
- new version: `0.26.0-0`
...
## mavros (lunar) - 0.26.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Wed, 06 Jun 2018 07:23:33 -0000`
...
## mavros (kinetic) - 0.26.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Wed, 06 Jun 2018 07:17:18 -0000`
...
## mavros (melodic) - 0.25.1-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Mon, 14 May 2018 16:21:30 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.25.0-0`
- old version: `0.25.0-0`
- new version: `0.25.1-0`
...
## mavros (lunar) - 0.25.1-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Mon, 14 May 2018 16:11:51 -0000`
...
## mavros (kinetic) - 0.25.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Mon, 14 May 2018 15:46:55 -0000`
...
## mavros (melodic) - 0.25.0-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros` on `Fri, 11 May 2018 18:13:51 -0000`
...
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.24.0-0`
- old version: `0.24.0-0`
- new version: `0.25.0-0`
...
## mavros (lunar) - 0.25.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Fri, 11 May 2018 18:08:19 -0000`
...
## mavros (kinetic) - 0.25.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic mavros` on `Fri, 11 May 2018 09:01:20 -0000`
...
## mavros (melodic) - 0.24.0-0

The packages in the `mavros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic mavros --new-track` on `Mon, 07 May 2018 20:38:16 -0000`
...
## mavros (lunar) - 0.24.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -t lunar -r lunar mavros` on `Thu, 05 Apr 2018 19:53:48 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.23.2-0`
- old version: `0.23.2-0`
- new version: `0.23.3-0`
...
## mavros (kinetic) - 0.23.3-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Fri, 09 Mar 2018 07:13:37 -0000`
...
## mavros (lunar) - 0.23.2-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Wed, 07 Mar 2018 07:46:35 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.23.1-0`
- old version: `0.23.1-0`
- new version: `0.23.2-0`
...
## mavros (kinetic) - 0.23.2-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Wed, 07 Mar 2018 07:32:07 -0000`
...
## mavros (lunar) - 0.23.1-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Tue, 27 Feb 2018 10:46:44 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.23.0-0`
- old version: `0.23.0-0`
- new version: `0.23.1-0`
...
## mavros (kinetic) - 0.23.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Tue, 27 Feb 2018 10:40:56 -0000`
...
## mavros (lunar) - 0.23.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Sat, 03 Feb 2018 13:37:06 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.22.0-0`
- old version: `0.22.0-0`
- new version: `0.23.0-0`
...
## mavros (kinetic) - 0.23.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Sat, 03 Feb 2018 13:29:00 -0000`
...
## mavros (lunar) - 0.22.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Mon, 11 Dec 2017 15:01:34 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.5-0`
- old version: `0.21.5-0`
...
## mavros (kinetic) - 0.22.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Mon, 11 Dec 2017 14:55:12 -0000`
...
## mavros (lunar) - 0.21.5-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Thu, 16 Nov 2017 20:31:50 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.4-0`
- old version: `0.21.4-0`
- new version: `0.21.5-0`
...
## mavros (kinetic) - 0.21.5-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 16 Nov 2017 20:10:53 -0000`
...
## mavros (lunar) - 0.21.4-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Wed, 01 Nov 2017 12:45:06 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.3-0`
- old version: `0.21.3-0`
- new version: `0.21.4-0`
...
## mavros (kinetic) - 0.21.4-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Wed, 01 Nov 2017 12:19:06 -0000`
...
## mavros (lunar) - 0.21.3-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Sat, 28 Oct 2017 21:27:38 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.2-0`
- old version: `0.21.2-0`
- new version: `0.21.3-0`
...
## mavros (kinetic) - 0.21.3-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Sat, 28 Oct 2017 21:20:24 -0000`
...
## mavros (lunar) - 0.21.2-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro lunar --track lunar mavros` on `Mon, 25 Sep 2017 10:30:16 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.1-0`
- old version: `0.21.1-0`
...
## mavros (kinetic) - 0.21.2-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic --track kinetic mavros` on `Mon, 25 Sep 2017 10:02:39 -0000`
...
## mavros (lunar) - 0.21.1-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro lunar --track lunar mavros` on `Fri, 22 Sep 2017 17:50:43 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.21.0-0`
- old version: `0.21.0-0`
- new version: `0.21.1-0`
...
## mavros (kinetic) - 0.21.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic --track kinetic mavros` on `Fri, 22 Sep 2017 13:22:20 -0000`
...
## mavros (lunar) - 0.21.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Thu, 14 Sep 2017 21:29:36 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.20.1-0`
- old version: `0.20.1-0`
- new version: `0.21.0-0`
...
## mavros (kinetic) - 0.21.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 14 Sep 2017 21:13:52 -0000`
...
## mavros (lunar) - 0.20.1-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Mon, 28 Aug 2017 09:23:41 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.20.0-0`
- old version: `0.20.0-0`
- new version: `0.20.1-0`
...
## mavros (kinetic) - 0.20.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Mon, 28 Aug 2017 09:10:11 -0000`
...
## mavros (kinetic) - 0.20.0-1

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Sat, 26 Aug 2017 08:18:26 -0000`
...
## mavros (lunar) - 0.20.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar mavros` on `Wed, 23 Aug 2017 19:03:01 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.19.0-0`
- old version: `0.19.0-0`
- new version: `0.20.0-0`
...
## mavros (kinetic) - 0.20.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Wed, 23 Aug 2017 15:53:52 -0000`
...
## mavros (lunar) - 0.19.0-0

The packages in the `mavros` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro lunar --track lunar mavros --new-track` on `Thu, 25 May 2017 15:16:15 -0000`
...
## mavros (kinetic) - 0.19.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release mavros -t kinetic -r kinetic` on `Fri, 05 May 2017 06:37:19 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.7-0`
- old version: `0.18.7-0`
- new version: `0.19.0-0`
...
## mavros (kinetic) - 0.18.7-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic mavros` on `Fri, 24 Feb 2017 23:44:34 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.6-0`
- old version: `0.18.6-0`
- new version: `0.18.7-0`
...
## mavros (kinetic) - 0.18.6-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release mavros -t kinetic -r kinetic` on `Tue, 07 Feb 2017 11:44:49 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.5-0`
- old version: `0.18.5-0`
...
## mavros (jade) - 0.17.5-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release mavros -t jade -r jade` on `Tue, 07 Feb 2017 11:27:32 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.17.4-0`
- old version: `0.17.4-0`
- new version: `0.17.5-0`
...
## mavros (indigo) - 0.17.5-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release mavros -t indigo -r indigo` on `Tue, 07 Feb 2017 11:20:00 -0000`
...
## mavros (kinetic) - 0.18.5-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Mon, 12 Dec 2016 14:08:46 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.4-0`
- old version: `0.18.4-0`
...
## mavros (kinetic) - 0.18.4-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 10 Nov 2016 22:40:56 -0000`
...
## mavros (kinetic) - 0.18.3-1

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 07 Jul 2016 08:45:41 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.2-0`
- old version: `0.18.3-0`
...
## mavros (kinetic) - 0.18.3-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro kinetic -t kinetic mavros` on `Thu, 07 Jul 2016 08:09:49 -0000`
...
## mavros (kinetic) - 0.18.2-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 30 Jun 2016 07:31:09 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.18.1-0`
- old version: `0.18.1-0`
- new version: `0.18.2-0`
...
## mavros (kinetic) - 0.18.1-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Fri, 24 Jun 2016 17:50:46 -0000`
...
## mavros (kinetic) - 0.18.0-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Thu, 23 Jun 2016 16:38:22 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.17.3-0`
- old version: `0.17.3-0`
...
## mavros (jade) - 0.17.4-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros -e` on `Thu, 23 Jun 2016 11:24:25 -0000`
...
## mavros (indigo) - 0.17.4-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 23 Jun 2016 11:01:14 -0000`
...
## mavros (indigo) - 0.17.3-1

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 23 Jun 2016 10:49:13 -0000`
...
## mavros (indigo) - 0.17.3-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 23 Jun 2016 10:41:54 -0000`
...
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.17.3-0`
- old version: `0.17.2-0`
- new version: `0.17.3-0`
...
## mavros (kinetic) - 0.17.3-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Fri, 20 May 2016 09:52:59 -0000`
...
## mavros (jade) - 0.17.3-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Fri, 20 May 2016 09:45:52 -0000`
...
## mavros (kinetic) - 0.17.2-1

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros` on `Sun, 15 May 2016 08:43:57 -0000`
...
## mavros (kinetic) - 0.17.2-0

The packages in the `mavros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic mavros --new-track` on `Fri, 29 Apr 2016 12:24:11 -0000`
...
## mavros (jade) - 0.17.2-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Fri, 29 Apr 2016 12:14:27 -0000`
...
## mavros (indigo) - 0.17.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Fri, 29 Apr 2016 12:07:53 -0000`
...
## mavros (jade) - 0.17.1-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Mon, 28 Mar 2016 03:19:43 -0000`
...
## mavros (indigo) - 0.17.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 28 Mar 2016 03:10:36 -0000`
...
## mavros (jade) - 0.17.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Tue, 09 Feb 2016 19:08:16 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.6-0`
- old version: `0.16.6-0`
...
## mavros (indigo) - 0.17.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Tue, 09 Feb 2016 18:55:14 -0000`
...
## mavros (jade) - 0.16.6-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Thu, 04 Feb 2016 10:22:51 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.5-0`
- old version: `0.16.5-0`
- new version: `0.16.6-0`
...
## mavros (indigo) - 0.16.6-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 04 Feb 2016 10:18:05 -0000`
...
## mavros (jade) - 0.16.5-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Sun, 10 Jan 2016 23:55:28 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.4-0`
- old version: `0.16.4-0`
- new version: `0.16.5-0`
...
## mavros (indigo) - 0.16.5-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Sun, 10 Jan 2016 22:48:51 -0000`
...
## mavros (jade) - 0.16.4-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Mon, 14 Dec 2015 07:29:56 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.3-0`
- old version: `0.16.3-0`
- new version: `0.16.4-0`
...
## mavros (indigo) - 0.16.4-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 14 Dec 2015 07:22:38 -0000`
...
## mavros (jade) - 0.16.3-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Thu, 19 Nov 2015 13:57:31 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.2-0`
- old version: `0.16.2-0`
- new version: `0.16.3-0`
...
## mavros (indigo) - 0.16.3-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 19 Nov 2015 13:52:30 -0000`
...
## mavros (jade) - 0.16.2-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Tue, 17 Nov 2015 08:00:41 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/mavlink/mavros-release.git
- rosdistro version: `0.16.1-0`
- old version: `0.16.1-0`
...
## mavros (indigo) - 0.16.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Tue, 17 Nov 2015 07:42:02 -0000`
...
## mavros (jade) - 0.16.1-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Fri, 13 Nov 2015 05:39:32 -0000`
...
## mavros (indigo) - 0.16.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Fri, 13 Nov 2015 05:33:54 -0000`
...
## mavros (jade) - 0.16.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Mon, 09 Nov 2015 11:14:25 -0000`
...
## mavros (indigo) - 0.16.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 09 Nov 2015 11:07:48 -0000`
...
## mavros (jade) - 0.15.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Thu, 17 Sep 2015 19:25:05 -0000`
...
## mavros (indigo) - 0.15.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 17 Sep 2015 18:54:17 -0000`
...
## mavros (jade) - 0.14.2-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Thu, 20 Aug 2015 00:50:25 -0000`
...
## mavros (indigo) - 0.14.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Thu, 20 Aug 2015 00:39:00 -0000`
...
## mavros (jade) - 0.14.1-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Wed, 19 Aug 2015 13:49:53 -0000`
...
## mavros (indigo) - 0.14.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Wed, 19 Aug 2015 12:27:00 -0000`
...
## mavros (jade) - 0.14.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Mon, 17 Aug 2015 16:34:50 -0000`
...
## mavros (indigo) - 0.14.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 17 Aug 2015 16:18:26 -0000`
...
## mavros (jade) - 0.13.1-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Wed, 05 Aug 2015 12:17:22 -0000`
...
## mavros (indigo) - 0.13.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Wed, 05 Aug 2015 12:09:14 -0000`
...
## mavros (jade) - 0.13.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Fri, 31 Jul 2015 22:58:43 -0000`
...
## mavros (indigo) - 0.13.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Fri, 31 Jul 2015 22:54:23 -0000`
...
## mavros (jade) - 0.12.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Wed, 01 Jul 2015 15:51:15 -0000`
...
## mavros (indigo) - 0.12.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Wed, 01 Jul 2015 15:46:16 -0000`
...
## mavros (jade) - 0.11.2-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Sun, 26 Apr 2015 15:58:54 -0000`
...
## mavros (indigo) - 0.11.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Sun, 26 Apr 2015 15:36:34 -0000`
...
## mavros (jade) - 0.11.1-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Mon, 06 Apr 2015 11:30:25 -0000`
...
## mavros (indigo) - 0.11.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 06 Apr 2015 11:27:05 -0000`
...
## mavros (jade) - 0.11.0-0

The packages in the `mavros` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade mavros` on `Tue, 24 Mar 2015 16:27:00 -0000`
...
## mavros (indigo) - 0.11.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Tue, 24 Mar 2015 16:05:40 -0000`
...
## mavros (indigo) - 0.10.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Sat, 24 Jan 2015 10:19:50 -0000`
...
## mavros (indigo) - 0.9.4-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 05 Jan 2015 21:07:35 -0000`
...
## mavros (indigo) - 0.9.3-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Tue, 30 Dec 2014 19:02:29 -0000`
...
## mavros (indigo) - 0.9.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Tue, 04 Nov 2014 08:18:00 -0000`
...
## mavros (hydro) - 0.8.5-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Tue, 04 Nov 2014 08:11:18 -0000`
...
## mavros (indigo) - 0.9.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 03 Nov 2014 09:21:17 -0000`
...
## mavros (hydro) - 0.8.3-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Mon, 03 Nov 2014 07:14:32 -0000`
...
## mavros (indigo) - 0.8.2-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Sun, 02 Nov 2014 21:38:59 -0000`
...
## mavros (hydro) - 0.8.2-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros --edit` on `Sun, 02 Nov 2014 21:28:26 -0000`
...
## mavros (indigo) - 0.8.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Sun, 02 Nov 2014 18:19:41 -0000`
...
## mavros (hydro) - 0.8.1-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Sun, 02 Nov 2014 18:15:41 -0000`
...
## mavros (indigo) - 0.8.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 22 Sep 2014 14:40:02 -0000`
...
## mavros (hydro) - 0.8.0-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Mon, 22 Sep 2014 14:36:25 -0000`
...
## mavros (indigo) - 0.7.1-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 25 Aug 2014 18:14:38 -0000`
...
## mavros (hydro) - 0.7.1-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Mon, 25 Aug 2014 18:10:16 -0000`
...
## mavros (indigo) - 0.7.0-0

The packages in the `mavros` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo mavros` on `Mon, 11 Aug 2014 20:11:32 -0000`
...
## mavros (hydro) - 0.7.0-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros` on `Mon, 11 Aug 2014 20:08:13 -0000`
...
## mavros (hydro) - 0.6.0-0

The packages in the `mavros` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --rosdistro hydro --track hydro mavros --edit` on `Thu, 17 Jul 2014 17:01:31 -0000`
